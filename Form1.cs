...
namespace Proyecto_Archivos
{
    public partial class Form1 : Form
    {
        ...
        string RutaArchivoIndicePrimario;
        string RutaArchivoIndiceSecundario;
        string RutaArchivoArbolPrimario;
        string RutaArchivoArbolSecundario;
        ...
        private void NuevoArchivoToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    RutaArchivo = VentanaGuardar.FileName;
        ...
        private void ActualizaDGVAtributos(Entidad e)
        {
            ...
            {
                DGV_Atributos.Rows.Add(a.AuxClave, a.ObtenCadenaNombre(), a.getTipoAtributo(), a.Longitud, a.Direccion_Atributo, a.Tipo_Indice, a.Direccion_Indice, a.Direccion_SiguienteAtributo);
            }
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (NuevoAtributo == true)
                    {
                        ...
                        Atributo nuevo = new Atributo(Clave, NombreAtributo, TipoDato, Longitud, DireccionAtributo, TipoIndice, -1, -1);
        ...
        private void ComboB_EntidadRegistros_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            RutaArchivoDatos = "Registros de datos\\" + Aux.ClaveEnString() + ".dat";
        ...
        private void ActualizaDGVRegistros(Entidad E)
        {
            ...
            {
                MessageBox.Show("QUE PEDO QUE PEDO");
                MessageBox.Show(e.Message);
            }
        }
        ...
        private void ObtenRutasIndicesEntidad(Entidad aux)
        {
            ...
            if (IndexPrimario != -1)
            {
                RutaArchivoIndicePrimario = "Indices Primarios\\" + aux.Atributos[IndexPrimario].ClaveEnString() + ".idx";
            ...
            {
                RutaArchivoIndiceSecundario = "Indices Secundarios\\" + aux.Atributos[IndexSecundario].ClaveEnString() + ".idx";
            ...
            {
                RutaArchivoArbolPrimario = "Arbol Primario\\" + aux.Atributos[IndexArbolPrimario].ClaveEnString() + ".idx";
            ...
            {
                RutaArchivoArbolSecundario = "Arbol Secundario\\" + aux.Atributos[IndexArbolSecundario].ClaveEnString() + ".idx";
        ...
        private void BT_EliminarRegistro_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MessageBox.Show(indiceRegistro.ToString());
                Entidad Aux = D.Entidades.ElementAt(indiceEntidadRegistro);
